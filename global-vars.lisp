...
(defvar *dbms-commands* '(defdb defrel restoredb restorerel defview
  delete insert modify destroydb destroyrel select project retrieve
  join set-intersection set-union set-difference mapon-alltuples
  printrel savedb saverel))
...
(defvar *ucl-attributes*
  '(:label "Attributes: "
    :default nil
    :type (:documentation
	   "Provide a list of attributes. If not all attributes all used."
	   :sexp)))
