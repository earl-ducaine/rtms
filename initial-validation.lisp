...
;;;INITIAl-VALIDATION
;;;
;;; This purpose of this function is to provide initial validation (error checking) for certain parameters. These types of checks are common
;;; across many of the user callable functions in RTMS.
